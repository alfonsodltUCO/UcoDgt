                                                                ...
                                                                mngC.getUser(cl, CheckPenaltyToAdd.this, new UserCallback() {
                                                                    ...
                                                                    public void onUserReceived(ClientDTO user) {
                                                                        ...
                                                                        EmailDTO email=new EmailDTO(user.getEmail(),"Dear "+user.getName()+",\nYou have received a new penalty.\n"+
                                                                                ...
                                                                                "UcoDgt,","New penalty");
                                                                        mngE.sendEmail(email, CheckPenaltyToAdd.this, new EmailCallback() {
                                                                            @Override
                                                                            public void onEmailSended(EmailDTO email) {
                                                                                ...
                                                                                overridePendingTransition(com.uco.ucodgt.R.anim.fadein, com.uco.ucodgt.R.anim.fadeout);
                                                                                finish();
                                                                                Toast.makeText(CheckPenaltyToAdd.this,"Penalty added and email sent", Toast.LENGTH_LONG).show();
                                                                                hideLoading();
                                                                            }
